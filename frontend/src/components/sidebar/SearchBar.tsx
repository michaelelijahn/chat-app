...
const SearchBar = () => {
    return (
        ...
        <input type="email" placeholder="Search Something..." className="w-full outline-none bg-white hover:border-none flex mt-2 p-3 text-sm rounded-lg bg-slate-50 text-gray-500 outline-1" />
      </div>
    )
  }
